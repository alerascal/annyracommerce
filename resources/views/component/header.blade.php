            ...
            <div class="col-md-4 col-lg-3 text-center text-lg-start">
                <div class="d-inline-flex align-items-center">
                    <a href="" class="navbar-brand p-0">
                        ...
                        <!-- <img src="frimg/logo.png" alt="Logo"> -->
                    </a>
                </div>
            </div>
    ...
    <div class="navbar-nav ms-auto py-0">
        ...
        <!-- Single Page -->
        <a href="{{ route('single') }}" 
           class="nav-item nav-link {{ Request::is('single') ? 'active' : '' }}">
            Single Page
        </a>
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu m-0">
                <a href="{{ route('bestseller') }}" class="dropdown-item">Bestseller</a>
        ...
        <a href="{{ route('contact') }}" 
           class="nav-item nav-link me-2 {{ Request::is('contact') ? 'active' : '' }}">
            Contact
        </a>
